...
export default function MotherPlusPage() {
  const product = getProductBySlug('mother-plus');
        ...
        <section className="py-8 md:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-sun-forest/70 via-transparent to-black/20 p-6 flex flex-col justify-between pointer-events-none">
                <div className="flex justify-between items-start pointer-events-auto">
                  <span className="px-3.5 py-1.5 rounded-full text-xs font-sans font-semibold uppercase tracking-wider bg-sun-olive text-sun-cream shadow-sm">
                    {product.category}
                  </span>
                  <button
            ...
            >
              <div>
                ...
                <p className="font-serif italic text-lg text-sun-olive font-medium mt-1">
                  Farm nutrition, conveniently preserved for mothers.
                </p>
              ...
              {product.disclaimer && (
                <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-950 flex items-start gap-3 text-xs leading-relaxed">
          ...
          <div className="mt-16 bg-sun-surface rounded-3xl p-8 border border-sun-border">
            <h3 className="font-serif text-2xl font-bold text-sun-forest mb-4">
              Maternal Nutrition Concept & Ingredients
            </h3>
            <p className="font-sans text-sm text-sun-charcoal/80 mb-6 leading-relaxed">
              SunHarvest Mother+ incorporates appropriately processed agricultural ingredients to provide wholesome food-based nutrition for mothers:
            </p>
